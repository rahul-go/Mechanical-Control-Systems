...
MODEL                := DCServoDAC
MODULES              := DCServoDAC_data.c DCServoDAC_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := DCServoDAC.mk
...
#
MODELLIB                  := DCServoDAClib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := DCServoDAC_ref.rsp
MODELREF_INC_PATH         := 
